...
public class MultiTenantMongoDbFactory extends SimpleMongoDbFactory {
     ...
     */
    public MultiTenantMongoDbFactory(MongoClient defaultClient, MongoProperties mongoProperties, MultiTenancyDataProperties multiTenancyDataProperties, String serviceName) {
    ...
    public void loadDataConfiguration() {
        ...
        if (StringUtils.isNotEmpty(this.multiTenancyDataProperties.getDatabaseSuffix())) {
            this.databaseSuffix = "-" + this.multiTenancyDataProperties.getDatabaseSuffix();
        } else {
